...
echo "=========================================================="
echo ""
echo " Grafana  (metrics + logs + traces) — NodePort 30300, no port-forward:"
echo "   http://localhost:3000  (agenticai / agentgrow.io)"
echo ""
echo " Prometheus (raw metrics) — no NodePort, needs a port-forward."
echo " Local 9090 is taken by the app's metrics NodePort, so use 9091:"
echo "   kubectl port-forward -n ${NAMESPACE} svc/kube-prometheus-stack-prometheus 9091:9090 &"
